...
# ------------------------------------------------------------------------------
# Paso 1: Descargar archivos si no existen en la carpeta 'source'
# ------------------------------------------------------------------------------
...
if not os.path.exists(source_dir) or not os.listdir(source_dir):
    ...
    try:
        # Asumimos que tu script download_packages.py tiene una función main() que descarga archivos.
...
# ------------------------------------------------------------------------------
# Paso 2: Procesar archivos para generar chunks
# ------------------------------------------------------------------------------
try:
    import chunking
...
# ------------------------------------------------------------------------------
# Paso 3: Almacenar embeddings en Neo4j (solo si aún no existen nodos)
# ------------------------------------------------------------------------------
try:
